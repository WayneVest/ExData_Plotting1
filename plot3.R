...
# Generate a line plot with only the Sub_metering_1 data
plot(sample_data$date_as_datetime, sample_data$Sub_metering_1, type='l', xlab='', ylab='Energy sub metering')
...
# Add a legend
legend("topright", lty=c(1,1,1), col=c('#000000', "#FF0000", '#0000FF'), legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))
